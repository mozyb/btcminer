                ...
                <tbody>
                  {miningFarms.map(f => (
                    <tr key={f.id} className="border-b border-border last:border-0">
                      ...
                      <td className="py-3 px-3 font-mono whitespace-nowrap">{f.capacity} {f.capacityUnit}</td>
                      <td className="py-3 px-3 font-mono whitespace-nowrap">{f.activeMiners.toLocaleString()}</td>
                      <td className="py-3 px-3 font-mono text-success whitespace-nowrap">{f.onlineMiners.toLocaleString()}</td>
                      <td className="py-3 px-3 whitespace-nowrap">
                        <Badge className="bg-success/10 text-success border-success/20">{f.uptime}%</Badge>
                      </td>
                      <td className="py-3 px-3 font-mono text-primary whitespace-nowrap">{f.totalBtcMined.toLocaleString()} ₿</td>
                    </tr>
                  ))}
                </tbody>
              </table>
