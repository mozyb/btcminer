...
| Property | Value |
|----------|-------|
| Endpoint | `GET https://app-cbv1cssxetxd-api-Xa6JZq2055oa.gateway.appmedo.com/search` |
...
```json
{
  ...
  "pagination": {
    "current": 1,
    "next": "https://app-cbv1cssxetxd-api-Xa6JZq2055oa.gateway.appmedo.com/search?start=10"
  }
}
```
...
async function searchGoogleScholar(params: ScholarSearchParams): Promise<ScholarResponse> {
  ...
  const response = await fetch(
    `https://app-cbv1cssxetxd-api-Xa6JZq2055oa.gateway.appmedo.com/search?${queryParams.toString()}`,
    {
      method: "GET",
      headers: {
