...
| Property | Value |
|----------|-------|
| Endpoint | `GET https://app-cbv1cssxetxd-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}` |
| HTTP Method | `GET` |
...
async function queryTask(taskId: string): Promise<QueryTaskResult> {
  const response = await fetch(
    `https://app-cbv1cssxetxd-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/${encodeURIComponent(taskId)}`,
    {
      method: "GET",
      headers: {
