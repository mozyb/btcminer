...
import {
  ...
  Megaphone, Users2, GitBranch, Tag, ShoppingCart, TrendingUp, ShieldCheck, Gift,
} from "lucide-react";
...
const adminNavItems: NavItem[] = [
  ...
  { label: "Marketing Automation", divider: true },
  { icon: Megaphone,        label: "Smart Popups",  href: "/admin/marketing/popups" },
  { icon: Gift,             label: "Welcome Offer", href: "/admin/marketing/welcome-offer" },
  { icon: Users2,           label: "Lead Capture",  href: "/admin/marketing/leads" },
  { icon: GitBranch,        label: "Sequences",     href: "/admin/marketing/sequences" },
  { icon: Send,             label: "Campaigns",     href: "/admin/marketing/campaigns" },
  { icon: Tag,              label: "Promotions",    href: "/admin/marketing/promotions" },
  { icon: ShoppingCart,     label: "Abandoned",     href: "/admin/marketing/abandoned" },
  { icon: TrendingUp,       label: "Analytics",     href: "/admin/marketing/analytics" },
  { icon: ShieldCheck,      label: "Compliance",    href: "/admin/marketing/compliance" },
];
