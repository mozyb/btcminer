...
**Endpoint:** `POST https://app-cbv1cssxetxd-api-2Y00Vzbe0MBY.gateway.appmedo.com/v1/images/omni-image`
...
async function submitOmniImageTask(params: SubmitParams): Promise<SubmitResult> {
  ...
  const response = await fetch(
    "https://app-cbv1cssxetxd-api-2Y00Vzbe0MBY.gateway.appmedo.com/v1/images/omni-image",
    {
      method: "POST",
      headers: {
