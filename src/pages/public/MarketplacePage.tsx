...
export default function MarketplacePage() {
  ...
  const btcPrice  = btc.btcPrice > 0 ? btc.btcPrice : 63000;
  ...
  const productSchemas = miningContracts.map(c => ({
    "@context": "https://schema.org",
    "@type": "Product",
    name: `${c.name} Bitcoin Mining Contract`,
    description: `${c.hashrate} ${c.hashrateUnit} ${c.algorithm} mining hashrate for ${c.duration} days.`,
    brand: { "@type": "Brand", name: "BTCMiner.online" },
    offers: {
      "@type": "Offer",
      price: c.totalPrice,
      priceCurrency: "USD",
      availability: c.availability > 0 ? "https://schema.org/InStock" : "https://schema.org/OutOfStock",
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-max text-sm bg-card border border-border rounded">
              ...
              <tbody>
                {miningContracts.map(c => {
                  const hashrateInTH = c.hashrateUnit === "PH/s" ? c.hashrate * 1000 : c.hashrateUnit === "GH/s" ? c.hashrate / 1000 : c.hashrateUnit === "MH/s" ? c.hashrate / 1e6 : c.hashrate;
                  ...
                  return (
                    <tr key={c.id} className="border-b border-border last:border-0 hover:bg-muted/30 transition-colors">
                      ...
                      <td className="py-3 px-4 whitespace-nowrap">{c.duration} days</td>
                      <td className="py-3 px-4 whitespace-nowrap">
                      ...
                      <td className="py-3 px-4 font-mono text-muted-foreground whitespace-nowrap">${c.maintenanceFee}/TH/d</td>
                      <td className="py-3 px-4 whitespace-nowrap">
                        {c.availability > 0
                          ? <span className="text-success font-mono">{c.availability} slots</span>
                ...
                >
                  ...
                  <CardContent className="p-5 flex flex-col flex-1">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <Badge className="bg-muted text-muted-foreground shrink-0">{c.duration}d</Badge>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4 text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-mono font-bold text-foreground">{c.hashrate} {c.hashrateUnit}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-mono text-foreground">{c.duration} days</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-mono text-foreground">${c.maintenanceFee}/TH/d</p>
                        </div>
                      </div>
                      <div>
                        <p className="text-xs text-muted-foreground">Available</p>
                        <p className={`font-mono text-sm ${c.availability > 0 ? "text-success" : "text-destructive"}`}>
                          {c.availability > 0 ? `${c.availability} slots` : "Sold Out"}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mt-auto flex items-center justify-between pt-4 border-t border-border gap-2">
                      <div>
                        ...
                        <p className="text-xl font-bold font-mono text-primary">${c.totalPrice.toLocaleString()}</p>
                      </div>
