...
export default function AdminDeposits() {
  ...
  const handleApprove = async (row: DepositRow) => {
    ...
    try {
      ...
      notifyUser({ type: "deposit", action: "approved", user_id: row.user_id, user_email: row.user_email, currency: row.currency, amount: row.amount, usd_value: row.usd_value, transaction_id: row.id });
  ...
  const handleReject = async (row: DepositRow) => {
    ...
    try {
      ...
      notifyUser({ type: "deposit", action: "rejected", user_id: row.user_id, user_email: row.user_email, currency: row.currency, amount: row.amount, usd_value: row.usd_value, transaction_id: row.id });
