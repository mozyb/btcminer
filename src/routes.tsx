...
import EmailPreferencesPage from './pages/dashboard/EmailPreferencesPage';
import AdminPopupManager from './pages/admin/AdminPopupManager';
import AdminLeadCapture from './pages/admin/AdminLeadCapture';
import AdminSequenceManager from './pages/admin/AdminSequenceManager';
import AdminCampaignManager from './pages/admin/AdminCampaignManager';
import AdminPromotions from './pages/admin/AdminPromotions';
import AdminAbandonedPurchases from './pages/admin/AdminAbandonedPurchases';
import AdminMarketingAnalytics from './pages/admin/AdminMarketingAnalytics';
import AdminComplianceConsent from './pages/admin/AdminComplianceConsent';
import AdminWelcomeOfferManager from './pages/admin/AdminWelcomeOfferManager';
...
export const routes: RouteConfig[] = [
  ...
  { name: 'Email Preferences', path: '/dashboard/email-preferences', element: <EmailPreferencesPage /> },
  // Admin
  ...
  // Admin Marketing Automation Center
  { name: 'Admin Popup Manager', path: '/admin/marketing/popups', element: <AdminPopupManager /> },
  { name: 'Admin Lead Capture', path: '/admin/marketing/leads', element: <AdminLeadCapture /> },
  { name: 'Admin Sequence Manager', path: '/admin/marketing/sequences', element: <AdminSequenceManager /> },
  { name: 'Admin Campaign Manager', path: '/admin/marketing/campaigns', element: <AdminCampaignManager /> },
  { name: 'Admin Promotions', path: '/admin/marketing/promotions', element: <AdminPromotions /> },
  { name: 'Admin Abandoned Purchases', path: '/admin/marketing/abandoned', element: <AdminAbandonedPurchases /> },
  { name: 'Admin Marketing Analytics', path: '/admin/marketing/analytics', element: <AdminMarketingAnalytics /> },
  { name: 'Admin Welcome Offer', path: '/admin/marketing/welcome-offer', element: <AdminWelcomeOfferManager /> },
  { name: 'Admin Compliance & Consent', path: '/admin/marketing/compliance', element: <AdminComplianceConsent /> },
