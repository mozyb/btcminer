...
export default function HomePage() {
  ...
  const activeBtcPrice  = btc.btcPrice > 0 ? btc.btcPrice : 63000;
      ...
      <section className="py-20 bg-card border-y border-border">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {miningContracts.filter(c => c.featured).map(contract => (
              <Card key={contract.id} className="bg-background border-border hover:border-primary/40 transition-colors h-full flex flex-col">
                <CardContent className="p-5 flex flex-col flex-1">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <Badge className="bg-primary/10 text-primary border-primary/20">{contract.duration}d</Badge>
                  </div>
                  <div className="grid grid-cols-2 gap-2 mb-4 flex-1">
                    <div><p className="text-xs text-muted-foreground">Hashrate</p><p className="font-mono font-bold text-foreground">{contract.hashrate} {contract.hashrateUnit}</p></div>
                    <div><p className="text-xs text-muted-foreground">Maintenance</p><p className="font-mono text-foreground">${contract.maintenanceFee}/TH/day</p></div>
                  </div>
                  <div className="flex items-center justify-between mt-auto">
                    <p className="text-lg font-bold text-primary font-mono">${contract.totalPrice.toLocaleString()}</p>
      ...
      <section className="py-20 bg-card border-y border-border">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { ...miningFarms[0], image: "https://miaoda-site-img.s3cdn.medo.dev/images/KLing_a457f067-1880-4b0e-a78c-18b8a11fe288.jpg" },
              { ...miningFarms[1], image: "https://miaoda-site-img.s3cdn.medo.dev/images/KLing_57235f2c-c096-4f5f-8270-1a732834c7f0.jpg" },
              { ...miningFarms[2], image: "https://miaoda-site-img.s3cdn.medo.dev/images/KLing_71508e24-93c2-40eb-8c10-e6dac1447ec8.jpg" },
              { ...miningFarms[3], image: "https://miaoda-site-img.s3cdn.medo.dev/images/KLing_b9a7f981-c899-4ce0-ae2b-b59513ef7fbe.jpg" },
            ].map(farm => (
              <Card key={farm.id} className="bg-background border-border overflow-hidden hover:border-primary/30 transition-colors h-full flex flex-col">
                ...
                <CardContent className="p-4 flex flex-col flex-1">
                  ...
                  <p className="text-xs text-muted-foreground mb-3">⚡ {farm.powerSource}</p>
                  ...
                  <div className="grid grid-cols-2 gap-1 text-xs mt-auto pt-3 border-t border-border">
                    <div><span className="text-muted-foreground">Capacity:</span><span className="text-foreground font-mono ml-1">{farm.capacity} {farm.capacityUnit}</span></div>
                    <div><span className="text-muted-foreground">Uptime:</span><span className="text-success font-mono ml-1">{farm.uptime}%</span></div>
                    <div><span className="text-muted-foreground">ASICs:</span><span className="text-foreground font-mono ml-1">{farm.activeMiners.toLocaleString()}</span></div>
                    <div><span className="text-muted-foreground">BTC mined:</span><span className="text-foreground font-mono ml-1">{farm.totalBtcMined.toLocaleString()}</span></div>
                  </div>
                </CardContent>
              </Card>
            ))}
