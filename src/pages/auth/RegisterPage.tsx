...
import { Cpu, Eye, EyeOff, CheckCircle, Gift, Sparkles } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="w-full max-w-lg">
        ...
        {isWelcome && (
          <div className="mb-4 rounded-xl border border-primary/30 bg-primary/10 p-4 flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-foreground flex items-center gap-2">
                ...
                Your 10% welcome discount is reserved
              </p>
              <p className="text-sm text-muted-foreground mt-1">
                Complete your free registration and verify your email to activate your discount on the first eligible mining contract.
              </p>
            </div>
          </div>
        )}
