...
**Endpoint:** `GET https://app-cbv1cssxetxd-api-V9gDze3qV2PL.gateway.appmedo.com/v1/data/eod`
...
async function getEodData(symbol: string, params: EodParams = {}): Promise<EodResponse> {
  ...
  const response = await fetch(
    `https://app-cbv1cssxetxd-api-V9gDze3qV2PL.gateway.appmedo.com/v1/data/eod?${query.toString()}`,
