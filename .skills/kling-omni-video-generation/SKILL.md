...
| Property | Value |
|----------|-------|
| Submit Endpoint | `POST https://app-cbv1cssxetxd-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video` |
| Query Endpoint | `GET https://app-cbv1cssxetxd-api-pLVzAEz1ZQOL.gateway.appmedo.com/v1/videos/omni-video/{task_id}` |
