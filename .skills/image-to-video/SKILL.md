...
| Item | Details |
|------|---------|
| Submit endpoint | `POST https://app-cbv1cssxetxd-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video` |
| Query endpoint | `GET https://app-cbv1cssxetxd-api-oYA6Z8wDBRDa.gateway.appmedo.com/v1/videos/image2video/{id}` |
