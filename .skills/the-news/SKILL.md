...
| Endpoint | Method | URL |
|----------|--------|-----|
| Top Stories | GET | `https://app-cbv1cssxetxd-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top` |
| All News | GET | `https://app-cbv1cssxetxd-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all` |
| Similar News | GET | `https://app-cbv1cssxetxd-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}` |
| News by UUID | GET | `https://app-cbv1cssxetxd-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}` |
| Sources | GET | `https://app-cbv1cssxetxd-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources` |

Base host: `app-cbv1cssxetxd-api-wL1zlEdVM6DY.gateway.appmedo.com`
